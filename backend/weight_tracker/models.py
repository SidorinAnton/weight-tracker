...
class UserMetrics(models.Model):
    ...
    weight = models.DecimalField(default=0, max_digits=2, decimal_places=2, verbose_name="Вес (кг)")
    waist_circumference = models.DecimalField(default=None, null=True, blank=True, max_digits=2, decimal_places=2, verbose_name="Обхват талии")
...
class UserGoal(models.Model):
    ...
    weight_goal = models.DecimalField(default=0, max_digits=2, decimal_places=2, verbose_name="Ожидаемый вес (кг)")
